...
```bash
git clone https://github.com/AbuObaidaZafar/spring-ai-project.git
...
|--------|----------|-------------|
| `GET` | `/api/chat?message={prompt}` | Send a prompt, get AI response |
| `POST` | `/api/chat` | Send a prompt via request body |

### Example Request

```bash
GET http://localhost:8080/api/chat?message=What is Spring AI?
```
...
3. URL: `http://localhost:8080/api/chat?message=Hello`
4. Click **Send**
5. View the AI response in the response body
